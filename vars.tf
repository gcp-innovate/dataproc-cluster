...
variable "staging_bucket" {
  ...
  default = "dataproc-storage-staging01"
}
...
variable "network" {
  ...
  default = "gcp-prj-vpc-01"
}

variable "subnetwork" {
  type = string
  description = "The name or self_link of the Google Compute Engine sub network to the cluster will be part of. Conflicts with subnetwork. If neither is specified, this defaults to the 'default' network."
  default = "subnet-1"
}
...
variable "conda_packages" {
  ...
  default = "pandas=0.23.4 scikit-learn=0.20.0 pytest=3.8.0 pyyaml=3.13"
}

variable "pip_packages" {
  type = string
  description = "A space separated list of pip packages to be installed"
  default = "gensim==3.7.1 logdecorator==2.1"
}
